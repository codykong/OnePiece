package com.xten.op.akka.mailbox
...
/**
  ...
  */
trait FlowAwareMessageQueueSemantics extends QueueBasedMessageQueue {
  def controlQueue: Queue[Envelope]
  def queue: Queue[Envelope]
  def enqueueNum : Option[Long]
  def dequeueNum : Option[Long]
